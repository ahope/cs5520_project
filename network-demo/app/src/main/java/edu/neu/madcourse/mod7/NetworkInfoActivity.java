...
public class NetworkInfoActivity extends AppCompatActivity {
    ...
    public void setNetworkPrefs(View view){
        startActivity(new Intent(this, NetworkSettingsPrefActivity.class));
    }
    ...
    public class NetworkReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if ("wi-fi only".equals(userNetworkPref) &&
                ...
                Toast.makeText(context, "Can do data task on mobile connection", Toast.LENGTH_LONG).show();

                // Otherwise, the app can't download content--either because there is no network
                // connection (mobile or Wi-Fi), or because the pref setting is WIFI, and there
                // is no Wi-Fi connection.
            } else {
                Toast.makeText(context, "Not connected, or can't do data task on mobile. ", Toast.LENGTH_LONG).show();
            }
        }
